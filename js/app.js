...
const pagination = (() => {
    ...
    const buttonAction = async (button) => {
        ...
        button.disabled = true;
        button.innerHTML = `<span class="spinner-border spinner-border-sm me-1"></span>Загрузка данных...`;
...
const comment = (() => {
    ...
    const loader = `<span class="spinner-border spinner-border-sm me-1"></span>Загрузка данных...`;
